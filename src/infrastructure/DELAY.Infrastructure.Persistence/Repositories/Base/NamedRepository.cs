...
namespace DELAY.Infrastructure.Persistence.Repositories.Base
{
        ...
        where TDomain : class, IKey, IName
    {
        ...
        public async Task<PagedData<KeyNamedModel>> GetKeyNameRecordsAsync(string name, PaginationOptions pagination, CancellationToken cancellationToken)
        {
            ...
            return new PagedData<KeyNamedModel>(count, records);
        }
    }
}
